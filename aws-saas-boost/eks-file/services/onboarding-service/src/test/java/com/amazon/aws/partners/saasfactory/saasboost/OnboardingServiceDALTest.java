...
public class OnboardingServiceDALTest {
    ...
    public void testToAttributeValueMap() {
        ...
        onboarding.setRequest(new OnboardingRequest("Unit Test", "default", "Test Email"));
        ...
        onboarding.setUserPoolId("userPoolid");
        ...
        expected.put("client_id", AttributeValue.builder().s("clientid").build());
        expected.put("user_pool_id", AttributeValue.builder().s("userPoolid").build());
        expected.put("tenant_name", AttributeValue.builder().s("tenantname").build());           
        ...
        expected.put("request", AttributeValue.builder().m(Map.of(
                ...
                "email", AttributeValue.builder().s("Test Email").build())
        ).build());
